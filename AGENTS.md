...
- Engine/project IDs are deployment-local. Do not commit live IDs.
- Region: `us-central1` in examples; override through config/env for real deployments.
...
- Auth: `gcloud auth application-default-login --project=YOUR_PROJECT_ID`
